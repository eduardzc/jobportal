...
import com.eduardz.jobportal.services.*;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        model.addAttribute("fullTime", Objects.equals(partTime, "FullTime"));
        ...
        model.addAttribute("officeOnly", Objects.equals(partTime, "oOffice-Only"));
        ...
        if(!dateSearcgFlag && !remote && !type && !StringUtils.hasText(job) && !StringUtils.hasText(location)) {
        ...
        if(!(currentUserProfile instanceof AnonymousAuthenticationToken)){
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
                ...
                List<JobSeekerSave> jobSeekerSaveList =
                        jobSeekerSaveService.getCandidatesJobs((JobSeekerProfile) currentUserProfile);
